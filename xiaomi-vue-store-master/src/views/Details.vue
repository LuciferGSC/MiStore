...
export default {
  ...
  mounted(){
    // if(this.productDetails === undefined || this.productPicture === undefined){
    //   this.productDetails = JSON.parse(localStorage.getItem("productDetails"));
    //   this.productPicture = JSON.parse(localStorage.getItem("productPicture"));
    // }
  },
  methods: {
    ...
    getDetailsPicture(val) {
       this.$axios
        ...
        .then(res => {
          ...
          localStorage.setItem("productPicture",JSON.stringify(this.productPicture));
