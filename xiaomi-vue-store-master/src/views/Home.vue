        ...
        <div class="phone">
          ...
          <div class="box-bd">
            <div class="promo-list">
              <router-link to>
                <img src="../../public/imgs/phone/phone.png" />
              </router-link>
            </div>
            <div class="list">
...
export default {
  ...
  created() {
    ...
    // 获取各类商品数据
    this.getPromo1(1, "phoneList");
    this.getPromo2(2, "miTvList");
    this.getPromo5(5, "protectingShellList");
    this.getPromo7(7, "chargerList");
    // this.getHot(
    //   "applianceList"
    // );
    this.getHot(
