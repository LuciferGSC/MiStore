      ...
      this.$axios
        ...
        .then(res => {
          ...
          if (this.productDetails.startTime > new Date().getTime()) {
              ...
              // if (this.remainSeconds > 60) { // 如果秒数大于60，将秒数转换成整数
              //   this.minute = parseInt(this.remainSeconds / 60) // 获取分钟，除以60取整数，得到整数分钟
              //   this.remainSeconds = parseInt(this.remainSeconds % 60) // 获取秒数，秒数取佘，得到整数秒数
              //   if (this.minute > 60) { // 如果分钟大于60，将分钟转换成小时
              //     this.hour = parseInt(this.minute / 60) // 获取小时，获取分钟除以60，得到整数小时
              //     this.minute = parseInt(this.minute % 60) // 获取小时后取佘的分，获取分钟除以60取佘的分
              //   }
              // }
              this.seckillState = 0;
