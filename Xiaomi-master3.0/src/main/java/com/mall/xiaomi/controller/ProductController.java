...
public class ProductController {
    ...
    public Map<String, Object> getProductBySearch(String search, String currentPage, String pageSize){
        PageInfo<Product> pageInfo =productService.getProductBySearch(search,currentPage,pageSize);
        HashMap<String, Object> map = new HashMap<>();
        map.put("code", "001");
        map.put("data", pageInfo.getList());
        map.put("total", pageInfo.getTotal());
